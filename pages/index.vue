          ...
          <div class="flex flex-col items-center space-y-8 md:space-y-12 text-center">
            ...
            <div class="w-full max-w-2xl mx-auto mt-8 md:mt-16">
              <div class="bg-navy-800/30 backdrop-blur-sm p-4 md:p-8 shadow-lg">
                ...
                <form class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 items-center justify-center mb-4 w-full">
                  <input 
                    type="text" 
                  ...
                  >
                  <button class="w-full bg-coral-500 text-white px-6 py-3 font-bold hover:bg-coral-400 transition-colors text-base md:text-lg">
                ...
                <form class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 items-center justify-center w-full">
                  <input 
                    type="email" 
                    placeholder="Email" 
                    class="w-full px-4 py-3 bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:border-coral-500 text-base md:text-lg"
                  >
                  <button class="w-full border border-coral-500 text-coral-500 px-6 py-3 font-bold hover:bg-coral-500 hover:text-white transition-colors text-base md:text-lg bg-transparent">
                    Sign Up
                  </button>
                </form>
