...
<template>
  <main class="min-h-screen bg-white text-gray-900">
        ...
        <div class="max-w-6xl mx-auto w-full">
          <div class="flex flex-col items-center space-y-8 md:space-y-12 text-center">
            ...
            <div class="text-center">
              <h1 class="font-space-grotesk font-bold text-4xl sm:text-5xl md:text-7xl lg:text-8xl uppercase text-gray-900 mb-2">
                SATOSHI NEEDS YOU
              </h1>
            ...
            <!-- Hero Description -->
            <p class="text-lg md:text-xl text-gray-700 max-w-4xl leading-relaxed">
    ...
    <section id="what-happening" class="py-20 bg-gray-50 px-4 scroll-reveal">
      <div class="max-w-7xl mx-auto">
        <!-- Two Column Layout -->
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div class="space-y-8">
            <div class="bg-coral-500 inline-block px-8 py-4 mb-8 rounded-2xl">
            ...
            <div class="space-y-6">
              <!-- Card 1 -->
              <div class="group bg-white/60 backdrop-blur-md rounded-2xl overflow-hidden transition-all hover:bg-white/80 border border-gray-100">
                <div class="relative">
                  <div class="absolute top-0 left-0 w-1 h-full bg-coral-500 rounded-l-2xl"></div>
                  <div class="absolute top-0 left-0 w-16 h-1 bg-coral-500 rounded-tl-2xl"></div>
                  <div class="p-6 pl-10">
              ...
              <div class="group bg-white/60 backdrop-blur-md rounded-2xl overflow-hidden transition-all hover:bg-white/80 border-l-4 border-coral-500 border border-gray-100">
                <div class="relative">
                  <div class="absolute top-0 left-0 w-1 h-full bg-coral-500 rounded-l-2xl"></div>
                  <div class="absolute top-0 left-0 w-16 h-1 bg-coral-500 rounded-tl-2xl"></div>
                  <div class="p-6 pl-10">
            ...
            <div class="space-y-4 mb-8">
              ...
              <div class="group bg-white/60 backdrop-blur-md rounded-2xl overflow-hidden transition-all hover:bg-white/80 border border-gray-100">
                <div class="relative flex items-center">
                  ...
                  <div class="p-6 pl-10 flex items-center w-full">
                    <div class="text-2xl md:text-3xl font-bold text-coral-500/50 w-16 flex-shrink-0">01</div>
                    <p class="text-base md:text-lg text-gray-700 font-medium flex-1">Don't control consumer funds.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="group bg-white/60 backdrop-blur-md rounded-2xl overflow-hidden transition-all hover:bg-white/80 border border-gray-100">
                <div class="relative flex items-center">
                  ...
                  <div class="absolute top-0 left-0 w-16 h-1 bg-coral-500 rounded-tl-2xl"></div>
                  <div class="p-6 pl-10 flex items-center w-full">
                    <div class="text-2xl md:text-3xl font-bold text-coral-500/50 w-16 flex-shrink-0">02</div>
                    <p class="text-base md:text-lg text-gray-700 font-medium flex-1">Only provide software or computing services.</p>
                  </div>
                </div>
              </div>
              ...
              <div class="group bg-white/60 backdrop-blur-md rounded-2xl overflow-hidden transition-all hover:bg-white/80 border border-gray-100">
                <div class="relative flex items-center">
                  ...
                  <div class="absolute top-0 left-0 w-16 h-1 bg-coral-500 rounded-tl-2xl"></div>
                  <div class="p-6 pl-10 flex items-center w-full">
                    <div class="text-2xl md:text-3xl font-bold text-coral-500/50 w-16 flex-shrink-0">03</div>
                    <p class="text-base md:text-lg text-gray-700 font-medium flex-1">Don't act as financial intermediaries.</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section id="contact-representatives" class="py-20 bg-white px-4 scroll-reveal">
      <div class="max-w-4xl mx-auto">
        <div class="bg-gray-900 inline-block px-8 py-4 mb-12 rounded-2xl">
          <h2 class="font-space-grotesk font-bold text-2xl md:text-3xl uppercase text-white">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div class="mt-6 text-center">
              <button class="inline-flex items-center gap-2 px-6 py-3 bg-gray-50 text-gray-900 rounded-xl hover:bg-gray-100 transition-colors font-medium border border-gray-200">
          ...
          <div>
            <div class="bg-white/60 backdrop-blur-md p-8 rounded-2xl border border-white/20">
              ...
              <div class="space-y-4">
                <button class="w-full bg-blue-500/90 backdrop-blur-sm hover:bg-blue-600/90 text-white px-6 py-4 font-bold text-lg transition-colors duration-300 rounded-xl flex items-center justify-center gap-3">
                ...
                <button class="w-full bg-purple-600/90 backdrop-blur-sm hover:bg-purple-700/90 text-white px-6 py-4 font-bold text-lg transition-colors duration-300 rounded-xl flex items-center justify-center gap-3">
                  <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <button class="w-full bg-gradient-to-r from-purple-500/90 to-pink-500/90 hover:from-purple-600/90 hover:to-pink-600/90 backdrop-blur-sm text-white px-6 py-4 font-bold text-lg transition-colors duration-300 rounded-xl flex items-center justify-center gap-3">
                  <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                  </svg>
                  Share on Instagram
                ...
                <button class="w-full bg-black/90 backdrop-blur-sm hover:bg-gray-800/90 text-white px-6 py-4 font-bold text-lg transition-colors duration-300 rounded-xl flex items-center justify-center gap-3">
                  <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
