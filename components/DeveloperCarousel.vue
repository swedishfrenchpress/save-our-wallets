...
const quotes = [
  {
    text: `Without clear legal protections, we risk losing the very tools that make bitcoin sovereign and censorship-resistant. Section 109 of the CLARITY Act is critical to ensure that building or using non-custodial wallets isn't treated like a crime. If we don't act, innovation will leave the United States — and with it, our financial freedom.`,
    author: 'Matt Corallo',
